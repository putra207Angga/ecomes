    ...
    return div(classes: 'app-content-wrapper p-3 p-md-4', [
        ...
        div(classes: 'container-fluid', [
          div(classes: 'row align-items-center', [
            div(classes: 'col-sm-6', [
              h3(classes: 'mb-0 fw-bold text-body-emphasis', [Component.text('Live Chat & Customer Support')]),
      ...
      div(classes: 'card shadow-sm border-0 rounded-4 overflow-hidden', [
        div(classes: 'row g-0', [
          ...
          div(classes: 'col-md-4 col-lg-3 border-end bg-body-tertiary', [
            div(classes: 'p-3 bg-body border-bottom', [
              div(classes: 'input-group input-group-sm', [
                span(classes: 'input-group-text bg-body-tertiary border-end-0 text-muted', [i(classes: 'bi bi-search', [])]),
                input(
                  type: InputType.text,
            ...
            div(classes: 'contacts-list overflow-y-auto', styles: Styles(height: 520.px), [
              for (var c in customers)
                div(
                  classes:
                      'p-3 border-bottom role-button d-flex align-items-center gap-3 transition-all ${c.id == selectedContactId ? 'bg-primary-subtle border-start border-4 border-primary' : 'bg-body hover-bg-light'}',
                  ...
                  [
                    ...
                    div(classes: 'flex-grow-1 overflow-hidden', [
                      div(classes: 'd-flex align-items-center justify-content-between mb-1', [
                        h6(classes: 'fw-bold text-body-emphasis mb-0 text-truncate fs-7', [Component.text(c.name)]),
          ...
          // Right Chat Window
          div(classes: 'col-md-8 col-lg-9 d-flex flex-column bg-body', [
            // Chat Header
            div(classes: 'p-3 border-bottom d-flex align-items-center justify-content-between bg-body', [
              div(classes: 'd-flex align-items-center gap-3', [
                ...
                div([
                  h6(classes: 'fw-bold text-body-emphasis mb-0 fs-6', [Component.text(activeCustomer.name)]),
            ...
            // Messages Container
            div(classes: 'chat-body flex-grow-1 p-4 overflow-y-auto bg-body-tertiary', styles: Styles(height: 360.px), [
                ...
                for (var msg in currentChats)
                  div(classes: 'mb-3 d-flex flex-column ${msg.isAdmin ? 'align-items-end' : 'align-items-start'}', [
                    div(classes: 'd-flex align-items-center gap-1 mb-1', [
                      span(classes: 'fw-semibold fs-8 text-body-emphasis', [Component.text(msg.sender)]),
                      span(classes: 'text-muted fs-8', [Component.text('• ${msg.time}')]),
                    ]),
                    div(
                      classes: 'p-3 rounded-4 fs-7 shadow-sm ${msg.isAdmin ? 'bg-primary text-white rounded-top-right-0' : 'bg-body text-body-emphasis border rounded-top-left-0'}',
            ...
            div(classes: 'p-3 border-top bg-body', [
